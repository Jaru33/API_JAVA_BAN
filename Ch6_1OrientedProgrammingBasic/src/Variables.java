...
//	인스턴스 변수
//	intstace ver		클래스 영역 			인스턴스가 생성되었을때
...
//	그렇기 때문에 인스턴스 변수의 값을 읽어 오거나 저장하기 위해서는 먼저 인스턴스를
//	생성해야 한다
...
//	클래스 변수는 인스턴스 변수와 달리 인스턴스를 생성하지 않고도 언제라도 바로
...
//	사용 가능하며, 블럭을 벗어나면 소멸되어 사용할 수 없게 된다
